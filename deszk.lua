...
DeszK2.Name = "DeszK2"
DeszK2.Parent = ScreenGui
DeszK2.BackgroundColor3 = Color3.fromRGB(13, 13, 13)
DeszK2.BorderColor3 = Color3.fromRGB(13, 13, 13)
DeszK2.Position = UDim2.new(0.35988754, 0, 0.284848481, 0)
...
INFINITYIELD.Parent = ImageLabel
...
INFINITYIELD.Text = "Infinity Yield"
INFINITYIELD.TextColor3 = Color3.fromRGB(255, 255, 255)
INFINITYIELD.TextSize = 14.000
INFINITYIELD.MouseButton1Down:connect(function()
	
end)


ANIMACIONES.Name = "ANIMACIONES"
ANIMACIONES.Parent = ImageLabel
...
TEMPORAL.MouseButton1Down:connect(function()
...
local function ZDDJT_fake_script() -- DeszK2.LocalScript 
	local script = Instance.new('LocalScript', DeszK2)

	local frame = script.Parent.Parent.DeszK2
...
coroutine.wrap(ZDDJT_fake_script)()
